...
try
{
    ...
    if ( Os.isName( "Linux" ) )
    {
        artifact  = new File( out, "first-1.2.3-1.x86_64.rpm" );
    ...
    {
        artifact  = new File( out, "first-1.2.3.dmg" );
        if ( !artifact.exists() || artifact.isDirectory() )
        {
            System.err.println( "first-1.2.3.dmg file is missing or is a directory." );
            return false;
        }
    }
}
